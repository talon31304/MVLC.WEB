...
namespace LearnMVCBasics.Controllers
{
    public class SessionController : Controller
    {
            ...
            
        {
            ...
            ClassSessionData.SessionDates = new List<string>(new string[] { DateTime.Now.AddDays(-35).ToString("MM/dd/yyyy"), DateTime.Now.AddDays(-28).ToString("MM/dd/yyyy"), DateTime.Now.AddDays(-21).ToString("MM/dd/yyyy"), DateTime.Now.AddDays(-14).ToString("MM/dd/yyyy"), DateTime.Now.AddDays(-7).ToString("MM/dd/yyyy"), DateTime.Now.ToString("MM/dd/yyyy") });
